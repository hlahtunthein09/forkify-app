...
async function controlRecipes() {
    try {
        ...
        // console.log("ID: ", id);
        if (!id) return;
        (0, _recipeViewJsDefault.default).renderSpinn();
...
const controlSearchResults = async function() {
    try {
        (0, _resultViewJsDefault.default).renderSpinn();
        // 1) Get search query
        ...
        (0, _resultViewJsDefault.default).render(_modelJs.getSearchResultsPage()); // rendering page 1 as default
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _addRecipeViewJsDefault.default).renderSpinn();
        // Upload the new Recipe data
        await _modelJs.uploadRecipe(newRecipe);
        console.log("\uD83C\uDF70new Recipe: ", _modelJs.state.recipe);
        // Render new recipe
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
        // Success Message
        ...
        setTimeout(function() {
            ...
            (0, _addRecipeViewJsDefault.default).restoreForm();
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./config.js":"2hPh4","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","./views/resultView.js":"2iOri","./views/paginationView.js":"7NIiB","./views/bookmarksView.js":"1qGeA","./views/addRecipeView.js":"8AWnP","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const updateServings = function(newServings) {
    state.recipe.ingredients.forEach((ing)=>{
        if (ing.quantity !== null) ing.quantity = ing.quantity * newServings / state.recipe.servings;
...
const KEY = '2f072ec2-9fea-4bea-93ed-53f6a6a20bf7';
const MODAL_CLOSE_SEC = 2.5; // for testing
 // export const icons = 'section_12\icons.svg';
...
const AJAX = async function(url, uploadData) {
    try {
        ...
        ]); // use Promise.race to race fetching and timeout
...
},{"./View.js":"jSw21","url:../../../public/icons.svg":"8r3pW","fraction.js":"md6n5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jSw21":[function(require,module,exports,__globalThis) {
...
class View {
    _data;
    /**
     * Render the reeived object to the DOM
    ...
    update(data) {
        ...
        newElements.forEach((newEl, i)=>{
            ...
            if (!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== "") // console.log("NodeValue: ", newEl.firstChild?.nodeValue.trim());
...
class SearchView {
    ...
    addHandlerSearch(handler) {
        this._parentEl.addEventListener("submit", function(e) {
            e.preventDefault(); // as we use form to submit, we need to prevent default refreshing behavior of form.
            handler();
        });
    }
}
...
},{"url:../../../public/icons.svg":"8r3pW","./View.js":"jSw21","./previewView.js":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6tKHS":[function(require,module,exports,__globalThis) {
// import icons from "url:../../img/icons.svg";
// import { icons } from "../config.js";
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"url:../../../public/icons.svg":"8r3pW","./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7NIiB":[function(require,module,exports,__globalThis) {
// import icons from "url:../../img/icons.svg";
// import { icons } from "../config.js";
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) // Next Btn
        return this._generateMarkupBtnNext(curPage);
        // 3) Last Page
        if (curPage === numPages && numPages > 1) // Prev Btn
...
},{"url:../../../public/icons.svg":"8r3pW","./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1qGeA":[function(require,module,exports,__globalThis) {
// import icons from "url:../../img/icons.svg";
// import { icons } from "../config.js";
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"url:../../../public/icons.svg":"8r3pW","./View.js":"jSw21","./previewView.js":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
// import icons from "url:../../img/icons.svg";
// import { icons } from "../config.js";
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    constructor(){
        ...
        // for re-render the new recipe window
        this._originalMarkup = this._parentElement.innerHTML;
    }
    toggleWindow() {
        // restore form
        if (this._window.classList.contains('hidden')) this._parentElement.querySelector('form')?.reset();
...
},{"url:../../../public/icons.svg":"8r3pW","./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
//# sourceMappingURL=section_12.4a59a05f.js.map
